...
while True:
    ...
    if opcao == '1':
        valor_depositado = int(input('Informe a quantia que deseja depositar: \n'))
        ...
        saque(saldo=saldo, valor=valor_sacado, extrato=extrato, limite=SAQUE_MAXIMO, numero_saques=qtd_saques, limite_saques=LIMITE_SAQUES )       
